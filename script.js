...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function openSidebar() {
    ...
    gsap.fromTo(sidebar, { x: -300 }, { x: 0, duration: 0.5, ease: "power2.out" })
  ...
  function setupStreamControls(stream) {
    ...
    recordClassBtn.addEventListener("click", () => {
      ...
      // Placeholder alert
      alert(isRecording ? "Recording started (placeholder)" : "Recording stopped (placeholder)")
    })
        ...
        if (streamView) {
          ...
          gsap.to(streamView, {
            ...
            onComplete: () => {
              ...
              gsap.fromTo(cardsContainer, { opacity: 0, y: -30 }, { opacity: 1, y: 0, duration: 0.5 })
            },
          })
        } else {
    ...
    getStartedBtn.addEventListener("click", () => {
      ...
      gsap.to(landingPage, {
        ...
        onComplete: () => {
          ...
          gsap.fromTo(dashboard, { opacity: 0, y: 50 }, { opacity: 1, y: 0, duration: 0.5 })
        ...
        .then((stream) => {
          ...
          gsap.to(cardsContainer, {
            ...
            onComplete: () => {
              ...
              gsap.fromTo(streamView, { opacity: 0, scale: 0.9 }, { opacity: 1, scale: 1, duration: 0.5 })
    ...
    joinClassBtn.addEventListener("click", () => {
      ...
      gsap.to(cardsContainer, {
        ...
        onComplete: () => {
          ...
          gsap.fromTo(joinStreamView, { opacity: 0, scale: 0.9 }, { opacity: 1, scale: 1, duration: 0.5 })
  ...
  gsap.fromTo(".navbar", { y: -50, opacity: 0 }, { y: 0, opacity: 1, duration: 1, ease: "power2.out" })
  ...
  if (document.querySelector(".landing-page")) {
    ...
    // Animate page title
    gsap.fromTo(".page-title", { y: -30, opacity: 0 }, { y: 0, opacity: 1, duration: 1, ease: "power2.out" })
  ...
  gsap.fromTo(".hamburger-menu", { opacity: 0 }, { opacity: 1, duration: 1, delay: 1 })

  // Animate footer
  gsap.fromTo(".footer", { y: 50, opacity: 0 }, { y: 0, opacity: 1, duration: 1, delay: 1.5, ease: "power2.out" })
})
